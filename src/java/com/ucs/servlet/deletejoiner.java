 ...
 * @author MR.l
 */
public class deletejoiner extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String joinername=request.getParameter("joinername");
            
            try {
                reg.getConn();
                String sql = "delete from activityjoiner where a_id='"+a_id+"' and joinername='"+joinername+"'";
                reg.deleteConn(sql);
                request.getRequestDispatcher("showActivity.jsp?=a_id"+a_id).forward(request, response);
            } catch (Exception ex) {
